...
from signalforgeai.models.types import ModelMetrics
from signalforgeai.models.registry import get_provider_for_model
...
class DecisionAgent:
    ...
    def decide(
        ...
        *,
        ...
        model_id = os.getenv("SIGNALFORGEAI_MODEL_ID", "dummy_good")
