"""Production-pilot readiness check for SignalForge AI."""
...
from signalforgeai.export.validate import DatasetValidationResult, validate_dataset_jsonl, write_dataset_manifest
from signalforgeai.learning.curriculum import export_curriculum
from signalforgeai.logging.validate import validate_jsonl_file
    ...
    *,
    ...
    if training_preflight:
        ...
        training_preflight_payload = build_training_preflight(
            ...
            dry_run=True,
            config={
                "source": "signalforgeai-pilot-check",
...
def main(argv: Optional[list[str]] = None) -> int:
    parser = argparse.ArgumentParser(description="Run SignalForge AI production-pilot readiness checks.")
    ...
    parser.add_argument(
        "--hosted-model-id",
        type=str,
        default=os.getenv("SIGNALFORGEAI_HOSTED_MODEL_ID", "openai:gpt-5-mini"),
    )
    parser.add_argument(
        "--local-model-id",
        type=str,
        default=os.getenv("SIGNALFORGEAI_LOCAL_MODEL_ID", "ollama:ministral-3:8b"),
    )
    parser.add_argument(
        "--baseline",
        type=str,
    ...
    parser.add_argument(
        "--training-base-model",
        type=str,
        default=os.getenv("SIGNALFORGEAI_TRAINING_BASE_MODEL", "dummy/base"),
