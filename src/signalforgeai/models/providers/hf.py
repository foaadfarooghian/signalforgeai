# signalforgeai/models/providers/hf.py
...
class HFProvider:
    ...
    def _load(self, base_model: str, adapter: Optional[str]) -> Tuple[Any, Any]:
        ...
        require_flash = os.getenv("SIGNALFORGEAI_HF_REQUIRE_FLASH", "0").lower() in {"1", "true", "yes"}
        ...
        if torch.cuda.is_available():
            ...
            device = os.getenv("SIGNALFORGEAI_HF_DEVICE", "cuda:0")
        ...
        for label, kwargs, attn_impl in attempts:
            try:
                ...
                if os.getenv("SIGNALFORGEAI_HF_LOG_DEVICE_MAP", "1") != "0":
