...
from signalforgeai.models.base import ModelProvider
...
from signalforgeai.models.providers.openai_provider import OpenAIProvider
...
def get_provider_for_model(model_id: str) -> ModelProvider:
    forced_provider = os.getenv("SIGNALFORGEAI_PROVIDER", "").strip().lower()
