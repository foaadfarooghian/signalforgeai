"""Evaluation harness for SignalForge AI agents.
...
from signalforgeai.logging.inspect import summarise_trace, read_jsonl
...
from signalforgeai.evaluation.scorers import ScoringContext, resolve_scorer
from signalforgeai.evaluation.reward_schema import RewardV0
from signalforgeai.evaluation.reward_writer import write_rewards_jsonl
...
def _get_model_id() -> str:
    ...
    return os.getenv("SIGNALFORGEAI_MODEL_ID") or "unknown"
...
def _run_synth_agent(task: str, inputs: Dict[str, Any], emitter: JsonlEmitter) -> Dict[str, Any]:
    from signalforgeai.agents.synth_agent import SynthAgent
