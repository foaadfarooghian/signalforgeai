...
Usage:
  python -m signalforgeai.evaluation.diff results/a.results.json results/b.results.json
"""
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    p = argparse.ArgumentParser(description="Diff two SignalForge AI evaluation results files.")
