...
- emits SignalForge AI-compliant traces, and
...
```bash
python -m signalforgeai.evaluation.run src/signalforgeai/evaluation/benchmarks/v0/suites/research_v0.json
python -m signalforgeai.evaluation.run src/signalforgeai/evaluation/benchmarks/v0/suites/decision_v0.json
python -m signalforgeai.evaluation.run src/signalforgeai/evaluation/benchmarks/v0/suites/refactor_v0.json
```
