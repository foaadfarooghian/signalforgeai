"""Inspect and summarise SignalForge AI JSONL traces.

Usage:
  python -m signalforgeai.logging.inspect path/to/trace.jsonl
  python -m signalforgeai.logging.inspect path/to/trace.jsonl --json
"""
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    parser = argparse.ArgumentParser(description="Inspect a SignalForge AI JSONL trace.")
