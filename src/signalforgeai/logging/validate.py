"""Validation utilities for SignalForge AI JSONL traces.

Usage:
  python -m signalforgeai.logging.validate path/to/trace.jsonl
"""
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    parser = argparse.ArgumentParser(description="Validate a SignalForge AI JSONL trace.")
