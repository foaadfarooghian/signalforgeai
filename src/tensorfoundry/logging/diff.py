"""Diff two TensorFoundry JSONL traces.

Usage:
  python -m tensorfoundry.logging.diff logs/a.jsonl logs/b.jsonl
  python -m tensorfoundry.logging.diff logs/a.jsonl logs/b.jsonl --json
"""
