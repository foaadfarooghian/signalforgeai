...
from tensorfoundry.evaluation.harness import SuiteResult, run_suite
...
def format_distillation_markdown(payload: Dict[str, Any]) -> str:
    ...
    lines = [
        "# TensorFoundry Distillation Eval",
        "",
...
def main(argv: Optional[List[str]] = None) -> int:
    parser = argparse.ArgumentParser(description="Run a TensorFoundry distillation eval gate.")
