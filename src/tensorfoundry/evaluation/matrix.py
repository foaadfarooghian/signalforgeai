"""Benchmark matrix runner and frontier reports for TensorFoundry."""
...
def main(argv: Optional[List[str]] = None) -> int:
    parser = argparse.ArgumentParser(description="Run a TensorFoundry benchmark matrix.")
...
def _run_matrix_row(
    *,
    ...
    old_model_id = os.environ.get("TENSORFOUNDRY_MODEL_ID")
    ...
    try:
        ...
        if old_model_id is None:
            ...
            os.environ["TENSORFOUNDRY_MODEL_ID"] = old_model_id
